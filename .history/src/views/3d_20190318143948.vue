...
<body>
  ...
  <div id="optranslate">
    <p>translate x:
      <span id="translatex-span">0</span> px
    </p>
    <input
      type="range"
      min="-360"
    ...
    <br>
    <p>translate y:
      <span id="translatey-span">0</span> px
    </p>
    <input
      type="range"
      min="-360"
    ...
    <br>
    <p>translate z:
      <span id="translatez-span">0</span> px
    </p>
    <input
      type="range"
      min="-360"
...
html, body, div, span,
        ...
        #oprotate .range-control{width:721px;}
</style>
