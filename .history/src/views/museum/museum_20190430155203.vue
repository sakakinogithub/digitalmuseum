    ...
    <div class="wrap">
      <Scroll>
        ...
        <div class="value-props">
          <div class="container">
            <div class="row">
              <div class="col-sm-3 col-xs-6"><a class="value-prop" id="home-value-prop-intellisense-link" href="#introduction"><div class="value-prop-icon icon-quill"></div><div>introduction</div></a></div>
              <div class="col-sm-3 col-xs-6"><a class="value-prop" id="home-value-prop-debugging-link" href="#news"><div class="value-prop-icon icon-newspaper"></div><div>news</div></a></div>
              <div class="col-sm-3 col-xs-6"><a class="value-prop" id="home-value-prop-git-link" href="#relic"><div class="value-prop-icon icon-library"></div><div>relics</div></a></div>
              <div class="col-sm-3 col-xs-6"><a class="value-prop" id="home-value-prop-extensions-link" href="#activity"><div class="value-prop-icon icon-accessibility"></div><div>activity</div></a></div>
            </div>
          </div>
        </div>
        <vs-divider id="introduction"  color="rgb(106, 76, 156)">简介</vs-divider>
        <div class="swimlane">
          <div class="container">
            <div class="row">
              <div class="col-sm-4">
        ...
        <vs-divider id="news"  color="rgb(125, 108, 70)"><h1 class="slogen theme">
        ...
        <vs-divider id="relic"  color="rgb(9, 97, 72)">文物</vs-divider>
        <div class="relics">
         ...
         <vs-divider id="activity"  color="rgb(0, 137, 167)">活动</vs-divider>
        <div>
