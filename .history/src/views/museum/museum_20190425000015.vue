  ...
  <div class="screen">
    ...
    <div id="hundreds-of-extensions" class="swimlane hundreds-extensions">
        <div class="container">
            <div class="row">
                <div class="col-sm-4 col-sm-push-8">
                    <a id="home-marketplace-link" href="https://marketplace.visualstudio.com/VSCode" target="_blank"><img src="http://bwg.nwu.edu.cn/uploadfile/20170922/1506059065389308.jpg" class="hundreds-extensions-img" alt="Easily use extensions in VS Code" /></a>
                </div>
                <div class="col-sm-7 col-sm-pull-4">
