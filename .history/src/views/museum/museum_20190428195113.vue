            ...
            <vs-col type="flex" vs-justify="center" vs-align="center" vs-xs="6" vs-sm="4" vs-lg="2">
              <vs-card actionable class="cardx">
                ...
                <div slot="media">
                  <img
                    class="cardimg"
                    src="https://img.dpm.org.cn/Uploads/Picture/dc/14004[1024].jpg"
                  >
                </div>
                <div>
                  <p>黑陶高柄杯，新石器时代，口径7cm，足径6cm，高15cm。</p>
                </div>
                <div slot="footer">
            ...
            <vs-col type="flex" vs-justify="center" vs-align="center" vs-xs="6" vs-sm="4" vs-lg="2">
              <vs-card actionable class="cardx">
                ...
                <div slot="media">
                  <img
                    class="cardimg"
                    src="https://img.dpm.org.cn/Uploads/Picture/dc/14003[1024].jpg"
                  >
                </div>
                <div>
                  <p>彩陶弦纹瓶，口径8cm，足径6.5cm，高21.5cm。</p>
                </div>
                <div slot="footer">
                  <vs-row vs-justify="flex-end">
                    <vs-button type="gradient" color="danger">
