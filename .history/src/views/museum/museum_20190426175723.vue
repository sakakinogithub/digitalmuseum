        ...
        <div class="value-props">
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm-3 col-xs-6"><a class="value-prop" id="home-value-prop-extensions-link" href="#hundreds-of-extensions"><div class="value-prop-icon extensions-icon"></div>activity</a></div>
            </div>
          </div>
        </div>
