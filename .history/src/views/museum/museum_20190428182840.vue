        ...
        <div class="value-props">
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm-3 col-xs-6"><a class="value-prop" id="home-value-prop-debugging-link" href="#news"><div class="value-prop-icon icon-newspaper"></div>news</a></div>
              <div class="col-sm-3 col-xs-6"><a class="value-prop" id="home-value-prop-git-link" href="#relic"><div class="value-prop-icon icon-library"></div>relics</a></div>
              <div class="col-sm-3 col-xs-6"><a class="value-prop" id="home-value-prop-extensions-link" href="#activity"><div class="value-prop-icon icon-accessibility"></div>activity</a></div>
            </div>
          </div>
        </div>
