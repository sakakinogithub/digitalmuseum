    ...
    <div class="wrap">
      <Scroll>
        ...
        <div class="value-props">
          <div class="container">
            <div class="row">
              <div class="col-sm-3 col-xs-6"><a class="value-prop" id="home-value-prop-intellisense-link" href="#introduction"><div class="value-prop-icon icon-quill"></div>introduction</a></div>
              ...
              <div class="col-sm-3 col-xs-6"><a class="value-prop" id="home-value-prop-git-link" href="#relics"><div class="value-prop-icon icon-library"></div>relics</a></div>
