      ...
      <Scroll>
        ...
        <div class="relics">
          <vs-row vs-justify="center">
            <vs-col type="flex" vs-justify="center" vs-align="center" vs-xs="6"  vs-lg="3" class="cardleft">
            ...
            <vs-col type="flex" vs-justify="center" vs-align="center" vs-xs="6"  vs-lg="3" class="card">
              <vs-card actionable class="cardx">
                <div slot="header">
            ...
            <vs-col type="flex" vs-justify="center" vs-align="center" vs-xs="6"  vs-lg="3" class="cardright">
              <vs-card actionable class="cardx">
                <div slot="header">
